    ...
    <Layout>
      ...
      <section className="relative bg-primary text-white">
        ...
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1543286386-713bdd548da4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&h=800')" }}
        >
          <div className="container mx-auto px-4 h-full flex items-center z-20 relative">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">{t('about.title')}</h1>
              <p className="text-lg max-w-2xl">{t('about.description')}</p>
            </div>
          </div>
        </div>
      </section>
