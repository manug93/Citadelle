        ...
        >
          ...
          <div className="pt-5 pb-4 h-full overflow-y-auto">
            ...
            <nav className="mt-8 px-2 space-y-1">
              <Link href="/admin/dashboard">
                <a className="group flex items-center px-4 py-3 text-white bg-primary rounded-md" onClick={() => setSidebarOpen(false)}>
                  <BarChart4 className="mr-3 h-5 w-5 text-white" />
                  Tableau de bord
                </a>
              </Link>
              <Link href="/admin/news">
                <a className="group flex items-center px-4 py-3 text-gray-700 hover:bg-primary/5 rounded-md" onClick={() => setSidebarOpen(false)}>
