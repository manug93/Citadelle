...
import { Typography, Grid, Box, Button, TextField, Card, CardMedia, CardContent, CardActions, IconButton, Dialog, DialogTitle, DialogContent, DialogActions, MenuItem, Menu, ListItemIcon, ListItemText, Snackbar, Alert, CircularProgress } from '@mui/material';
import { AddPhotoAlternate, Delete, Edit, ContentCopy, MoreVert, Image } from '@mui/icons-material';
...
export default function ImageManagement() {
  ...
  return (
    <div id="images-section" className="mt-8">
